...
# sshpass -p "$SSH_PASS" ssh -T -L 10502:mffout.karlov.mff.cuni.cz:10502 hercik@acheron.ms.mff.cuni.cz -p 42049 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null &
