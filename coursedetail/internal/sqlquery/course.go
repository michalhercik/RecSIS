...
SELECT
    ...
    start_semester,
    semester_count,
    CASE WHEN taught_lang = 'CZE' THEN 'Czech' ELSE 'English' END AS taught_lang,
    lecture_range1,
    seminar_range1,
...
//     start_semester,
//     semester_count,
//     CASE WHEN taught_lang = 'CZE' THEN 'Czech' ELSE 'English' END,
//     lecture_range1,
//     seminar_range1,
//     COALESCE(lecture_range2, -1),
//     COALESCE(seminar_range2, -1),
//     exam_type,
//     credits,
//     guarantors,
//     teachers,
//     COALESCE(min_number, -1),
//     COALESCE(capacity, -1),
//     COALESCE(annotation, ''),
//     COALESCE(aim, ''),
