...
func TestCourseDetailServer(t *testing.T) {
	tests := []testCase{
		...
		{"repeated delete rating NSWI120 should return 200",
			"DELETE", "/course/rating/NSWI120", http.StatusOK},
		...
		{"delete rating category for non-existent course should return 400",
			"DELETE", "/course/rating/XXNOTXX/1", http.StatusNotFound},
		...
		{"delete rating for non-existent course should return 400",
			"DELETE", "/course/rating/XXNOTXX", http.StatusNotFound},
...
func TestBlueprintServer(t *testing.T) {
	tests := []testCase{
		...
		// =========================================
		// TODO: cannot test move course, because it requires a specific order of courses in the blueprint (missing recordID)
		{"blueprint unassign third year should return 200",
			"PATCH", "/blueprint/courses?type=year-unassign&year=3", http.StatusOK},
		...
		// TODO: cannot test move courses, because it requires a specific order of courses in the blueprint (missing recordID)
		// TODO: cannot test remove course, because it requires a specific order of courses in the blueprint (missing recordID)
		{"blueprint delete third year should return 200",
			"DELETE", "/blueprint/courses?type=year-remove&year=3", http.StatusOK},
		...
		// TODO: cannot test remove courses, because it requires a specific order of courses in the blueprint (missing recordID)
		...
		{"blueprint move courses without year should return 400",
			"PATCH", "/blueprint/courses?type=year-unassign", http.StatusBadRequest},
		{"blueprint move courses with empty year should return 400",
			"PATCH", "/blueprint/courses?type=year-unassign&year=", http.StatusBadRequest},
		{"blueprint move courses with invalid year should return 400",
			"PATCH", "/blueprint/courses?type=year-unassign&year=lorem", http.StatusBadRequest},
		{"blueprint move courses with negative year should return 400",
			"PATCH", "/blueprint/courses?type=year-unassign&year=-1", http.StatusBadRequest},
		{"blueprint move courses with non-existent year should return 400",
			"PATCH", "/blueprint/courses?type=year-unassign&year=5", http.StatusBadRequest},
		...
		{"blueprint remove courses without year should return 400",
			"DELETE", "/blueprint/courses?type=year-remove", http.StatusBadRequest},
		{"blueprint remove courses with empty year should return 400",
			"DELETE", "/blueprint/courses?type=year-remove&year=", http.StatusBadRequest},
		{"blueprint remove courses with invalid year should return 400",
			"DELETE", "/blueprint/courses?type=year-remove&year=lorem", http.StatusBadRequest},
		{"blueprint remove courses with negative year should return 400",
			"DELETE", "/blueprint/courses?type=year-remove&year=-1", http.StatusBadRequest},
		{"blueprint remove courses with non-existent year should return 400",
			"DELETE", "/blueprint/courses?type=year-remove&year=5", http.StatusBadRequest},
