...
SELECT
	s.degree_plan_code AS "plan.code",
	dp.title AS "plan.title",
	dp.valid_from AS "plan.valid_from",
	dp.valid_to AS "plan.valid_to",
	dp.field_code AS "plan.field_code",
	dp.field_title AS "plan.field_title",
	dp.required_credits AS "plan.required_credits",
	dp.required_elective_credits AS "plan.required_elective_credits",
	dp.total_credits AS "plan.total_credits",
	dp.studying AS "plan.studying",
	dp.graduates AS "plan.graduates",
	dp.requisite_graph_data AS "plan.requisite_graph_data",
