...
type text struct {
	...
	studyingStats           string
	graduatesStats          string
	yearStat                string
	totalStat               string
	numberStat              string
	avgYearsToGraduate      string
	code                    string
	title                   string
	status                  string
	completed               string
...
var texts = map[language.Language]text{
	language.CS: {
		...
		creditsStats:            "Kreditová bilance",
		totalCredits:            "Celkem kreditů",
		requiredCredits:         "Počet povinných kreditů",
		requiredElectiveCredits: "Počet povinně volitelných kreditů",
		studyingStats:           "Počet studujících",
		graduatesStats:          "Počet absolventů",
		yearStat:                "Ročník",
		totalStat:               "Celkem",
		numberStat:              "Počet",
		avgYearsToGraduate:      "Průměrný počet let studia",
		code:                    "Kód",
		title:                   "Název",
		status:                  "Stav",
		completed:               "Splněno",
	...
	language.EN: {
		...
		creditsStats:            "Credits Balance",
		totalCredits:            "Total Credits",
		requiredCredits:         "Number of Required Credits",
		requiredElectiveCredits: "Number of Required Elective Credits",
		studyingStats:           "Number of Studying Students",
		graduatesStats:          "Number of Graduates",
		yearStat:                "Year",
		totalStat:               "Total",
		numberStat:              "Number",
		avgYearsToGraduate:      "Average Years to Graduate",
		code:                    "Code",
		title:                   "Title",
		status:                  "Status",
		completed:               "Completed",
